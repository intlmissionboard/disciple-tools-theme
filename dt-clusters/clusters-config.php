 ...
 */
class Disciple_Tools_Clusters_Config
{
    ...
    public function remove_default_meta_boxes() {
        ...
        remove_meta_box( 'postexcerpt', 'clusters', 'normal' );
        remove_meta_box( 'trackbacksdiv', 'clusters', 'normal' );
        remove_meta_box( 'postcustom', 'clusters', 'normal' );
        remove_meta_box( 'commentstatusdiv', 'clusters', 'normal' );
        remove_meta_box( 'revisionsdiv', 'clusters', 'normal' );
        remove_meta_box( 'slugdiv', 'clusters', 'normal' );
        remove_meta_box( 'authordiv', 'clusters', 'normal' );
        remove_meta_box( 'sqpt-meta-tags', 'clusters', 'normal' );
    }
